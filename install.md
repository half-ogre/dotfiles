...
We prefer each tool's vendor-prescribed installation method over Homebrew,
unless Homebrew is the method the vendor recommends.
...
- Entire via `curl -fsSL https://entire.io/install.sh | sh` (per https://entire.io/)
